...
public class NlpirTest {
	...
	public void testFinerSegment(){
		...
		String t = "\n" +
				...
				"\n" +
				"\n" +
				"亲爱的firstbright@163.com，您好！\n" +
				"欢迎使用五百丁,请验证邮箱,如果此操作并不是由您发起的,请忽略此邮件.\n" +
				"验证邮箱 \n" +
				"如果按钮无法点击，请点击以下链接进行验证http://www.500d.me/register/bindEmail/?code=9572e833034dedf21cb8fae2ab8ff622 \n" +
				"Copyright © 2014-2016 500d.me. All Rights Reserved. \n" +
				"\t\t\n" +
				"\t\n" +
				"\t\n" +
				"\n";
		String result = NlpirMethod.NLPIR_FinerSegment(t);
		System.out.println(result);
	}
