package service.fenci.nlpir.demo;

import service.fenci.nlpir.util.OSInfo;
...
public interface NlpirLib extends Library {
    ...
    NlpirLib Instance = (NlpirLib) Native.loadLibrary(OSInfo.getModulePath("D:\\lunwen\\NLPIR-master\\NLPIR-master\\NLPIR SDK\\NLPIR-ICTCLAS\\lib\\win64\\NLPIR"), NlpirLib.class);
