...
if  __name__=="__main__":
    ...
    # Data Parameters
    tf.flags.DEFINE_string("input_text_file", r"cnn_content.mail", "Test text data source to evaluate.")
    tf.flags.DEFINE_string("input_label_file", "", "Label file for test text data source.")

    # Eval Parameters
    tf.flags.DEFINE_integer("batch_size", 64, "Batch Size (default: 64)")
    tf.flags.DEFINE_string("checkpoint_dir", r"1518355585 ","Evaluate on all training data")
